...
class ProductViewModel:ViewModel() {
    val cloudinaryUrl = "https://api.cloudinary.com/v1_1/djtsxn8aw/image/upload"
    val uploadPreset = "images_pos@1"

    fun uploadProduct(imageUri: Uri?,productName:String,productPrice:String,productQuantity:String,productDescription:String,
    ...
    val product: List<ProductModel> = _products
